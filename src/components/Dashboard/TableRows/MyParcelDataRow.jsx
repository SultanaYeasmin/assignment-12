...
const MyParcelDataRow = ({ refetch, index, parcel }) => {
    ...
    console.log(parcel)
    const { _id, name, email, phone_number, parcel_type, parcel_weight, price, receiver_name, receiver_phone_number, address, requested_delivery_date, latitude, longitude, status, delivery_man_ID, expected_delivery_date, booking_date }
        = parcel || {}
